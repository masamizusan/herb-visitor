...
export const EXCEL_PLANTS = [
  ...
  { id:"txt_B_45", name:"レモンバーベナ",          area:"B", x:326.04, y:380.76 },
  ...
  { id:"txt_D_50", name:"カレープランツ",          area:"D", x:172.20, y:374.24 },
  ...
  // txt_J_67 ドチアナセージ: 撤去済みの植物のため削除（2026-07-16）
  { id:"txt_J_68", name:"エキナセア(J)",           area:"J", x:451.51, y:338.24 },
  { id:"txt_J_69", name:"ラベンダーグロッソ",      area:"J", x:461.62, y:328.94 },
  ...
  { id:"txt_J_73", name:"ラベンダーグロッソ",      area:"J", x:470.36, y:431.73 },
  ...
  { id:"txt_W_154", name:"エニシダ",               area:"W", x:879.80, y:450.57 },
] as const
